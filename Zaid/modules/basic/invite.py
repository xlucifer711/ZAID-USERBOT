...
@Client.on_message(
    filters.command(["ادعي"], ".") & (filters.me | filters.user(SUDO_USER))
)
...
@Client.on_message(
    filters.command(["ادعي الكل"], ".") & (filters.me | filters.user(SUDO_USER))
)
...
@Client.on_message(filters.command("لنك الدعوه", ".") & filters.me)
...
add_command_help(
    ...
    [
        ...
        ["دعوه @username", "to invite someone."],
        ["ادعي الكل @username", "Mass adding (can affect your account)."],
    ],
)
